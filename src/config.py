...
SNOW_STORM_MIN_TIME = 5.0   # minimum duration for a snowstorm
SNOW_STORM_MAX_TIME = 10.0  # maximum duration for a snowstorm
SNOW_STORM_INTERVAL_MIN = 20.0  # minimum time between snowstorms
SNOW_STORM_INTERVAL_MAX = 40.0  # maximum time between snowstorms
